...
<div class="container">
    <div class="card shadow mb-4">
        ...
        <div class="card body">
            <form action="{{route('resume.store')}}" method="POST" enctype="multipart/form-data" class="form-horizontal" role="form">
                {{ csrf_field() }}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="NIK" class="form-control" name="nik" value="{{$currentUser->nik}}">
                    </div>
                </div>
